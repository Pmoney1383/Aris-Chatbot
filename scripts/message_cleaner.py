...
# Point INPUT_FILE at your raw iMessage export in data/raw/ before running.
INPUT_FILE = ROOT / "data" / "raw" / "+17787081028.txt"
OUTPUT_FILE = ROOT / "data" / "raw" / "clean_tagged.txt"
